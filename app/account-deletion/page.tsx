...
export const metadata: Metadata = { title: "Delete Your Account — Deepika Wellness" };
  ...
  return (
    <main className="mx-auto min-h-screen max-w-2xl px-6 py-12 text-ink">
      ...
      <p className="mt-5 text-[16px] leading-7 text-ink-soft">
        Send Deepika an account-deletion request through the coaching conversation inside the app.
        Include the username used to sign in. For security, Deepika will confirm the request with
      ...
      <p className="mt-8 text-sm leading-6 text-ink-soft">
        If you cannot sign in, contact Deepika through the same channel used to receive your
