 ...
 *
 * Kept in step with `lib/readiness.ts` on the server, which recomputes the
 * outcome on every save — this copy decides what to show, never what is true.
 *
...
import type { AvoidCondition, BodyLoad } from "./exerciseTypes";
